...
const features = [
  {
    ...
    description: 'Uncover your passions, skills, and values through our comprehensive Ikigai assessment. Our interactive process is designed to be insightful and thought-provoking, helping you build a deep understanding of what truly motivates you.',
    imageId: 'feature1',
  },
  {
    icon: <Bot className="w-8 h-8 text-primary" />,
    title: 'AI-Powered Recommendations',
    description: 'Receive personalized career paths and actionable roadmaps generated by our advanced AI. Our system analyzes your assessment results to suggest roles and industries where you can thrive, complete with skill-building suggestions.',
    imageId: 'feature2',
  },
  {
    icon: <Network className="w-8 h-8 text-primary" />,
    title: 'Dynamic Roadmap',
    description: 'Visualize your career journey, customize milestones, and track your progress towards success. Your roadmap is a living document that you can adapt as you grow, with checklists and resources to keep you on track.',
    imageId: 'feature3',
  },
];
