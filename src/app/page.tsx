...
const features = [
  {
    ...
    description: 'Uncover your passions, skills, and values.',
  },
  {
    icon: <Bot className="w-8 h-8 text-primary" />,
    title: 'AI-Powered Recommendations',
    description: 'Receive personalized career paths.',
  },
  {
    icon: <Network className="w-8 h-8 text-primary" />,
    title: 'Dynamic Roadmap',
    description: 'Visualize your career journey and track progress.',
  },
];
        ...
        <section id="career-copilot" className="py-24">
          <div className="container grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-square rounded-xl overflow-hidden shadow-2xl transform hover:-translate-y-2 transition-transform duration-300">
              {(() => {
                const image = PlaceHolderImages.find((p) => p.id === 'copilot');
                return image && <Image src={image.imageUrl} alt="Career Co-Pilot" fill className="object-cover" data-ai-hint={image.imageHint} />;
              })()}
            </div>
          </div>
        </section>
